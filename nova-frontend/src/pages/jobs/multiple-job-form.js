...
const MultipleJobForm = ({ formOpen, closeForm }) => {
    ...
    return (
        <>
            <Dialog style={{ width: '50%', margin: 'auto' }} open={formOpen} onClose={cleanCloseForm} fullWidth>
                <DialogTitle>Multiple Division Job Form</DialogTitle>
                <DialogContent>
                    <Formik
                        enableReinitialize
                        ...
                        onSubmit={async (values, { setErrors, setSubmitting }) => {
                            var job = {};
                            var args = [];
                            job.job_name = 'multiple_division_job_new';
...
export default MultipleJobForm;
